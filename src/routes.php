...
$rotas->add('modalidade', new Route('/Modalidade', array('_controller' => 'NutriSport\Controllers\ControleModalidade','_method' => 'modalidade')));
...
$rotas->add('relatorioModalidade', new Route('/relatorioModalidade', array('_controller' =>'NutriSport\Controllers\ControleModalidade','_method' => 'relatorioModalidade')));
...
$rotas->add('buscarPlano', new Route('/buscarPlano', array('_controller' =>'NutriSport\Controllers\ControlePlano','_method' => 'buscarPlano')));
...
$rotas->add('relatorioPlano', new Route('/relatorioPlano', array('_controller' =>'NutriSport\Controllers\ControlePlano','_method' => 'relatorioPlano')));
