...
class ControlePlano {
    ...
    public function cadPlano() {
         ...
         if($this->sessao->get("usuario") == ""){
            ...
            return $this->response->setContent($this->twig->render('CadastroPlano.html', array('user' => $this->sessao->get("usuario"))));
    ...
    public function editarPlano() {
         ...
         if($this->sessao->get("usuario") == ""){
            ...
            return $this->response->setContent($this->twig->render('EditarPlano.html.html', array('user' => $this->sessao->get("usuario"))));
        }else if($this->sessao->get("usuario")->status == 2){
           return $this->response->setContent($this->twig->render('IndexCliente.html', array('user' => $this->sessao->get("usuario"))));
        } 
