...
class ControleModalidade {
    ...
    public function cadModalidade() {
         ...
         if($this->sessao->get("usuario") == ""){
            ...
            return $this->response->setContent($this->twig->render('CadastroModalidade.html', array('user' => $this->sessao->get("usuario"))));
    ...
    public function editarModalidade() {
         ...
         if($this->sessao->get("usuario") == ""){
            ...
            return $this->response->setContent($this->twig->render('EditarModalidade.html', array('user' => $this->sessao->get("usuario"))));
        }else if($this->sessao->get("usuario")->status == 2){
           return $this->response->setContent($this->twig->render('IndexCliente.html', array('user' => $this->sessao->get("usuario"))));
        } 
    }
